...
N 310 -140 410 -140 {
lab=V_CFBOT}
C {devices/vsource.sym} -160 -500 0 0 {name=V4 value="PULSE(0 5 0 0.1n 0.1n 66.5n 100n)"}
...
C {devices/vsource.sym} -160 -320 0 0 {name=V6 value="PULSE(0 5 16.6n 0.1n 0.1n 33.3n 100n)"}
...
C {devices/vsource.sym} -160 -410 0 0 {name=V5 value="PULSE(5 0 16.6n 0.1n 0.1n 33.3n 100n)"}
...
C {devices/vsource.sym} -160 -230 0 0 {name=V7 value="PULSE(0 5 66.6n 0.1n 0.1n 33.3n 100n)"}
