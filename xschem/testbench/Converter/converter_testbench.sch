...
C {devices/lab_wire.sym} 290 -550 0 0 {name=l18 sig_type=std_logic lab=D1}
C {devices/lab_wire.sym} 290 -490 0 0 {name=l20 sig_type=std_logic lab=D2}
C {devices/lab_wire.sym} 290 -430 0 0 {name=l25 sig_type=std_logic lab=D2_N}
C {devices/lab_wire.sym} 290 -370 0 0 {name=l26 sig_type=std_logic lab=D1_N}
C {devices/lab_wire.sym} 500 -260 3 0 {name=l27 sig_type=std_logic lab=V_CFTOP}
C {devices/lab_wire.sym} 590 -260 3 0 {name=l28 sig_type=std_logic lab=V_CFBOT}
C {devices/lab_wire.sym} 820 -460 0 1 {name=l29 sig_type=std_logic lab=VOUT_CORE}
C {devices/lab_wire.sym} 780 -530 2 0 {name=l32 sig_type=std_logic lab=VH}
C {devices/lab_wire.sym} 780 -390 2 0 {name=l33 sig_type=std_logic lab=VSS}
C {devices/isource.sym} 1050 -400 0 0 {name=I0 value=0.15
}
C {devices/lab_wire.sym} 970 -330 0 0 {name=l1 sig_type=std_logic lab=VSS}
C {devices/res.sym} 970 -400 0 0 {name=R2
value=22
footprint=1206
device=resistor
m=1}
C {personal/3LFCC_AC3E/xschem/hierarchy_sch/converter.sym} 300 -270 0 0 {name=X1}
