...
wrdata /foss/designs/personal/3LFCC_AC3E/xschem/testbench/Core/3LFCC_v1p5_wfilter_jmtest.txt tran.v(vout_core) tran.i(v3) tran.i(v4) tran.i(v9)
...
C {devices/res.sym} 1010 -270 0 0 {name=R2
value=22
footprint=1206
device=resistor
m=1}
