...
N 470 -510 500 -510 { lab=V_CFTOP}
N 470 -560 470 -540 { lab=VH}
N 470 -410 500 -410 { lab=VOUT_CORE}
...
C {devices/lab_wire.sym} 390 -310 0 0 {name=l3 sig_type=std_logic lab=D1_5V}
C {devices/lab_wire.sym} 390 -210 0 0 {name=l4 sig_type=std_logic lab=D2_5V}
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 450 -410 0 0 {name=MN3
L=0.5
W=4.38
nf=1
mult=2520
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 450 -510 0 0 {name=MN4
L=0.5
W=4.38
nf=1
mult=2520
...
C {personal/Joel/LS.sym} 310 -20 0 0 {name=x1}
...
C {personal/Joel/LS.sym} 310 120 0 0 {name=x2}
