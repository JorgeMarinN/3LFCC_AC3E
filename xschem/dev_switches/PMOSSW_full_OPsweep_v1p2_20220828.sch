...
C {devices/vsource.sym} 80 -320 0 0 {name=VDD value=5}
...
C {devices/code_shown.sym} 50 -200 0 0 {name=s1 only_toplevel=false value="
*.param VIN = 20
*.param RL = 50
*.option temp=70
*.ic v(V_CFTOP) = VIN/2
...
*dc VGS -5 5 0.1 VS 0 10 1
*dc VGS -5 0 0.1 VS 0 5 1
