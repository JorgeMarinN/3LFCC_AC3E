...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 680 -310 0 0 {name=MN1
L=0.5
W=4.38
nf=1
mult=2520
...
C {devices/vsource.sym} 250 -320 0 0 {name=VGS value=1.8}
...
C {devices/vsource.sym} 80 -320 0 0 {name=VDS value=1.8}
...
C {devices/code_shown.sym} 60 -640 0 0 {name=s1 only_toplevel=false value="
.param VIN = 20
.param RL = 50
*.option temp=70
*.ic v(V_CFTOP) = VIN/2
