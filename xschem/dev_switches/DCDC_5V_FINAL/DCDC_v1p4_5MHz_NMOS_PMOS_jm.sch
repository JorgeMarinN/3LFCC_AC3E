...
N 390 -310 430 -310 { lab=D2BOT_5V}
...
N 390 -210 430 -210 { lab=D1BOT_5V}
...
C {devices/lab_wire.sym} 390 -510 0 0 {name=l1 sig_type=std_logic lab=D1TOP_5V}
C {devices/lab_wire.sym} 390 -410 0 0 {name=l2 sig_type=std_logic lab=D2_5V}
C {devices/lab_wire.sym} 390 -310 0 0 {name=l3 sig_type=std_logic lab=D2BOT_5V}
C {devices/lab_wire.sym} 390 -210 0 0 {name=l4 sig_type=std_logic lab=D1BOT_5V}
...
C {devices/vsource.sym} -810 -110 0 0 {name=V3 value="PULSE(0 \{VIN\} 5n 0.1n 0.1n 5n 20n)"}
...
C {devices/vsource.sym} -520 -110 0 0 {name=V4 value="PULSE(0 \{VIN\} 15n 0.1n 0.1n 5n 20n)"}
...
wrdata ~/Documents/Postdoc/chipathon2022/3LFCC_AC3E/xschem/dev_switches/DCDC_5V_FINAL/3LFCC_v1p4.txt tran.v(vout) tran.i(v5) tran.i(v1)
...
C {devices/lab_wire.sym} 560 10 0 0 {name=l25 sig_type=std_logic lab=D1TOP_5V}
C {devices/lab_pin.sym} 70 210 0 1 {name=l26 sig_type=std_logic lab=D2
}
C {devices/lab_wire.sym} 500 200 0 0 {name=l27 sig_type=std_logic lab=VH}
C {devices/lab_wire.sym} 560 200 0 0 {name=l28 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 550 270 0 0 {name=l29 sig_type=std_logic lab=D2TOP_5V}
