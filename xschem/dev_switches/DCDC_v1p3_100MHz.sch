...
N 470 -510 500 -510 { lab=VDD}
N 500 -560 500 -510 { lab=VDD}
N 470 -560 500 -560 { lab=VDD}
N 470 -560 470 -540 { lab=VDD}
N 470 -410 500 -410 { lab=V_CFTOP}
N 500 -460 500 -410 { lab=V_CFTOP}
N 470 -460 500 -460 { lab=V_CFTOP}
...
C {devices/lab_wire.sym} 390 -310 0 0 {name=l3 sig_type=std_logic lab=D2}
C {devices/lab_wire.sym} 390 -210 0 0 {name=l4 sig_type=std_logic lab=D1}
C {devices/vsource.sym} -700 -350 0 0 {name=V1 value=\{VIN\}}
C {devices/gnd.sym} -700 -300 0 0 {name=l5 lab=GND}
C {devices/lab_wire.sym} 470 -560 0 0 {name=l7 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} -700 -430 0 0 {name=l8 sig_type=std_logic lab=VDD}
C {devices/vsource.sym} -810 -110 0 0 {name=V3 value="PULSE(0 \{VIN\} 5n 0.3n 0.3n 5n 20n)"}
...
C {devices/vsource.sym} -520 -110 0 0 {name=V4 value="PULSE(0 \{VIN\} 15n 0.3n 0.3n 5n 20n)"}
