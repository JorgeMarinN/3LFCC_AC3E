...
C {devices/code_shown.sym} 70 -770 0 0 {name=s1 only_toplevel=false value="
.param VIN = 20
.param RL = 50
*.option temp=70
*.ic v(V_CFTOP) = VIN/2
...
.dc IDS 0.2 0.3 0.001
.save all

*.wrdata PMOS_out.txt v(vds)
"}
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 680 -310 0 0 {name=MP2
L=0.5
W=4.38
nf=1
mult=4506
